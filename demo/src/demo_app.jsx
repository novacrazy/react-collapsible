    ...
    render() {
        return (
            <div>
                ...
                <div>
                    <button onClick={this.onToggleCollapsible.bind(this)}>
                        Toggle Collapsible
                    </button>
                    <Collapsible ref="demo" style={{border: "1px solid black", paddingLeft: 10, paddingRight: 10}}>
                        <p>
